...
welcome_label = tk.Label(home_frame, text="Welcome to the Banking App!", font=("Arial", 16, "bold"),bg="DARK GREEN",fg="WHITE")
welcome_label.pack()

account_button = tk.Button(home_frame, text="Account", font=("Arial", 14), command=navigate_account,bg="GREEN")
account_button.pack()

# Account screen
account_frame = tk.Frame(window)

account_label = tk.Label(account_frame, text="Account", font=("Arial", 16, "bold"),bg="RED")
account_label.pack()
...
deposit_entry.pack()
deposit_button = tk.Button(account_frame, text="Deposit", font=("Arial", 12), command=deposit_amount,bg="RED")
deposit_button.pack()
...
withdraw_entry.pack()
withdraw_button = tk.Button(account_frame, text="Withdraw", font=("Arial", 12), command=withdraw_amount,bg="RED")
...
# Set initial account
current_account = Account(account_number="CUR001", balance=50000)
